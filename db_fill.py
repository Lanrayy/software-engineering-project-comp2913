...
scooter = models.scooter(id = 108, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 109, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 200, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 202, availability = 1, collection_id = 2)
db.session.add(scooter)

scooter = models.scooter(id = 202, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 203, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 204, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 205, availability = 1, collection_id = 2)
db.session.add(scooter)

scooter = models.scooter(id = 206, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 207, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 208, availability = 1, collection_id = 2)
db.session.add(scooter)
scooter = models.scooter(id = 209, availability = 1, collection_id = 2)
db.session.add(scooter)
